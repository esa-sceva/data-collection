...
class EPJPhotovoltaicsJournalScraper(BaseIterativeIssuesPublisherScraper):
    @property
    ...
    def _scrape_issue(
        ...
        issue_url = os.path.join(journal.url,"articles", journal.name, "abs", issue_num, "01/contents/contents.html")
